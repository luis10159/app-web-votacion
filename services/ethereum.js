...
let contractAddress = '0x42779eFB1cEb547557906DEc592E2B66e49368f7';
let contractABI = [{"inputs":[],"stateMutability":"nonpayable","type":"constructor"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"votante","type":"address"},{"indexed":true,"internalType":"uint256","name":"indiceCandidato","type":"uint256"}],"name":"VotoRegistrado","type":"event"},{"inputs":[{"internalType":"uint256","name":"index","type":"uint256"}],"name":"Votante","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"string","name":"name","type":"string"},{"internalType":"uint256","name":"indexParty","type":"uint256"},{"internalType":"uint256","name":"indexFaculty","type":"uint256"}],"name":"addCandidate","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"string","name":"name","type":"string"},{"internalType":"uint256","name":"year","type":"uint256"}],"name":"addElection","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint32","name":"indexCandidate","type":"uint32"},{"internalType":"uint32","name":"indexElection","type":"uint32"}],"name":"addElectionPartyCandidate","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"string","name":"name","type":"string"}],"name":"addFaculty","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"string","name":"name","type":"string"}],"name":"addParty","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"getCandidates","outputs":[{"components":[{"internalType":"uint256","name":"idCandidate","type":"uint256"},{"internalType":"string","name":"name","type":"string"},{"internalType":"uint256","name":"votesCount","type":"uint256"},{"components":[{"internalType":"uint256","name":"idParty","type":"uint256"},{"internalType":"string","name":"name","type":"string"}],"internalType":"struct Vote.Party","name":"party","type":"tuple"},{"components":[{"internalType":"uint256","name":"idFaculty","type":"uint256"},{"internalType":"string","name":"name","type":"string"}],"internalType":"struct Vote.Faculty","name":"faculty","type":"tuple"}],"internalType":"struct Vote.InfoCandidate[]","name":"","type":"tuple[]"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getElections","outputs":[{"components":[{"internalType":"uint256","name":"idElection","type":"uint256"},{"internalType":"string","name":"name","type":"string"},{"internalType":"uint256","name":"year","type":"uint256"}],"internalType":"struct Vote.Election[]","name":"","type":"tuple[]"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getFaculties","outputs":[{"components":[{"internalType":"uint256","name":"idFaculty","type":"uint256"},{"internalType":"string","name":"name","type":"string"}],"internalType":"struct Vote.Faculty[]","name":"","type":"tuple[]"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getNumberCandidates","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getNumberElections","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getNumberFaculties","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getNumberParties","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getOwner","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getParties","outputs":[{"components":[{"internalType":"uint256","name":"idParty","type":"uint256"},{"internalType":"string","name":"name","type":"string"}],"internalType":"struct Vote.Party[]","name":"","type":"tuple[]"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getelectionsCandidates","outputs":[{"components":[{"internalType":"uint256","name":"idElectionPartyCandidate","type":"uint256"},{"components":[{"internalType":"uint256","name":"idElection","type":"uint256"},{"internalType":"string","name":"name","type":"string"},{"internalType":"uint256","name":"year","type":"uint256"}],"internalType":"struct Vote.Election","name":"election","type":"tuple"},{"components":[{"internalType":"uint256","name":"idCandidate","type":"uint256"},{"internalType":"string","name":"name","type":"string"},{"internalType":"uint256","name":"votesCount","type":"uint256"},{"components":[{"internalType":"uint256","name":"idParty","type":"uint256"},{"internalType":"string","name":"name","type":"string"}],"internalType":"struct Vote.Party","name":"party","type":"tuple"},{"components":[{"internalType":"uint256","name":"idFaculty","type":"uint256"},{"internalType":"string","name":"name","type":"string"}],"internalType":"struct Vote.Faculty","name":"faculty","type":"tuple"}],"internalType":"struct Vote.InfoCandidate","name":"candidate","type":"tuple"}],"internalType":"struct Vote.DetalleResultados[]","name":"","type":"tuple[]"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"owner","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"}]
...
export default {
  ...
  addCandidate: async (candidateName,indexpartido,indexfacultad,toast) => {
    try {
      ...
      // Puedes manejar el resultado de la transacción aquí, si es necesario
      console.log('Transacción exitosa:', result);
      toast.add({ severity: 'success', summary: 'Creación Exitosa', detail: "El candidato fue asignado ", life: 3000 });
  ...
  addElection: async (electionsName,yearElections,toast) => {
    try {
      ...
      // Puedes manejar el resultado de la transacción aquí, si es necesario
      console.log('Transacción exitosa:', result);
      toast.add({ severity: 'success', summary: 'Creación exitosa', detail: "La elección fue creada correctamente", life: 3000 });
      return result;
    } catch (error) {
